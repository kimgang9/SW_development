...
# 데이터셋 경로
train_data_dir = 'C:/Users/LEE/PycharmProjects/sw_dev/dataset/car-part-dataset/train'
test_data_dir = 'C:/Users/LEE/PycharmProjects/sw_dev/dataset/car-part-dataset/test'
...
# 모델을 2개의 클래스로 저장
torch.save(model.state_dict(), 'efficientnet_model_binary_class_with_augmentation.pt')
print("모델 저장 완료: efficientnet_model_binary_class_with_augmentation.pt")
