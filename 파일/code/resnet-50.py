...
train_generator = train_datagen.flow_from_directory(
        train_dir,
        target_size=(224, 224),# resizing 224x224
        batch_size=10,
        class_mode='binary')
...
model = tf.keras.models.Sequential([
  ...
  tf.keras.layers.Dense(256, activation='relu'), # 추가된 Dense 레이어
  tf.keras.layers.Dense(128, activation='relu'), # 추가된 Dense 레이어
...
#Test accuracy : 0.8445377945899963
#Test loss : 0.4630492925643921
